...
- Version 1.0.7 (29-07-2014) fixed a minor bug in spanning/encompassing reads argument interpretation. Number of spanning and encompassing reads is now provided in output file.
...
SPANNING_READS Reads that span the fusion junction, i.e. contain fusion junction in the sequence
SUPPORTING_READS Reads that encompass fusion junction, i.e. read pairs in which read mates are mapped to different exons being fused
