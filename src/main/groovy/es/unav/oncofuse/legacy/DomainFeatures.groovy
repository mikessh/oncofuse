...
class DomainFeatures {
    // Stage 1:
    final Set<String> domainsRetained = new HashSet<String>(),
                      domainsLost = new HashSet<String>(),
                      domainsBroken = new HashSet<String>()
    final List<String> piisRetained = new ArrayList<String>(),
                       piisLost = new ArrayList<String>()
